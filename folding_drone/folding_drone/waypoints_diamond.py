...
class WaypointsDiamond(Node):
    def __init__(self):
        super().__init__('waypoints_diamond')  	                    #initiating the node
        ...
        joing_angle_at_shape = 0.0

        position_0 = [-1.4,0.0,-0.6,0.0,0.0,0.0]  # x,y,z, yaw, joint_angle, cumulative time
        position_1 = [-1.4,0.0,-0.6,0.0,0.0,20.0]  
        position_2 = [-1.4,0.0,-1.2,0.0,0.0,30.0]
        position_3 = [-1.4,0.0,-1.2,0.0,0.0,45.0]
        position_4 = [-1.4,0.0,-1.2,0.0,joing_angle_at_shape,55.0]
        position_5 = [0.0,1.4,-1.2,0.0,joing_angle_at_shape,60.0]
        position_6 = [1.4,0.0,-1.2,0.0,joing_angle_at_shape,65.0]
        position_7 = [0.0,-1.4,-1.2,0.0,joing_angle_at_shape,70.0]
        position_8 = [-1.4,0.0,-1.2,0.0,joing_angle_at_shape,75.0]
        position_9 = [-1.4,0.0,-0.2,0.0,0.0,85.0]

        self.positions = np.array([position_0,position_1,position_2,position_3,position_4,position_5,position_6,position_7,position_8,position_9])
...
def main(args=None):
    ...
    waypoints_diamond = WaypointsDiamond()  #initializing class

    rclpy.spin(waypoints_diamond)         # running in loop

    #ending the processes (currently, the programme does not reach this point)
    waypoints_diamond.destroy_node() 
    rclpy.shutdown()
